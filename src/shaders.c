...
static const struct PresetConfig presets[] = {
    {"cyberpunk", 0,  19660, 32768, 2949120, false, 0, 0, 0},
    {"retro",     4,  13107, 52428, 0,       false, 0, 0, 0},
    {"matrix",    10, 32768, 78643, 5898240, false, 0, 0, 0},
    {"sunset",    1,  9830,  19660, 1966080, false, 0, 0, 0},
    {"vaporwave", 3,  16384, 45875, 4915200, false, 0, 0, 0},
    {"ocean",     6,  6553,  26214, 3276800, false, 0, 0, 0},
    {"forest",    2,  8192,  39321, 1638400, false, 0, 0, 0},
    {"blood",     8,  26214, 65536, 0,       false, 0, 0, 0},
