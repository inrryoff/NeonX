...
│   └── msgs.c/.h           # Define o idioma da ferramenta
├── tools/                       # Ferramentas auxiliares
│   ├── keygen.c           # Gera chaves para builds oficiais
│   └── sign_binary.c      # Anexa assinatura ao binário
├── keys/                        # Chaves privadas e publicas ficam aqui
│    ├── priv.key           # Chave privada gerada pela keygen
│    ├── minisig.pub   # Chave publica Minisign
│    └── pub.key           # Chave privada Minisign
├── build.sh                 # Script genérico para builds locais (devs)
├── .github/workflows     # Diretório de workflows
│    └── tests.yml       # Workflows do GitHub Actions
└── verify.sh              # Verificador de binários oficiais públicos 
```
...
Este script detectará automaticamente o seu compilador (`clang`) e criará o binário em `./build/neonx`. 
