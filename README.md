...
- **Integridade Blindada:** Verificação Ed25519 (Monocypher) embutida contra modificações.
- **Portátil:** Binário estático único para Linux, macOS, Android (Termux) e Windows.
...
Escolha sua plataforma e siga as instruções para instalar a versão **v2.1.1-STABLE**:
...
curl -LO https://github.com/inrryoff/NeonX/releases/download/v2.1.1/neonx_linux-x64.zip
...
curl -LO https://github.com/inrryoff/NeonX/releases/download/v2.1.1/neonx_linux-arm64.zip
...
curl -LO https://github.com/inrryoff/NeonX/releases/download/v2.1.1/neonx_macos-arm64.zip
...
curl.exe -LO https://github.com/inrryoff/NeonX/releases/download/v2.1.1/neonx_windows-x64.zip
...
curl -LO https://github.com/inrryoff/NeonX/releases/download/v2.1.1/neonx_wasm.zip
